...
public class FastIO {
    public static void main(String[] args) throws Exception {
        ...
        InputReader4 in4 = new InputReader4(new FileInputStream("file.in"));
        ...
        for (int i = 0; i < n; i++) {
            data1[i] = in1.nextInt(); //don't need to worry about spaces or new line, taken care of by method
        }
        ...
        start = System.currentTimeMillis();
        for (int i = 0; i < n; i++) {
            data2[i] = in2.nextInt(); //don't need to worry about spaces or new line, taken care of by method
        }
        System.out.println(System.currentTimeMillis() - start);
        pw.println(data2[0]);
        System.gc(); //GC BEFORE NEXT RUN
        ...
        start = System.currentTimeMillis();
        for (int i = 0; i < n; i++) {
            data3[i] = in3.nextInt(); //don't need to worry about spaces or new line, taken care of by method
        }
        System.out.println(System.currentTimeMillis() - start);
        pw.println(data3[0]);
        System.gc(); //GC BEFORE NEXT RUN
        ...
        start = System.currentTimeMillis();
        for (int i = 0; i < n; i++) {
            data4[i] = in4.nextInt(); //don't need to worry about spaces or new line, taken care of by method
        }
        System.out.println(System.currentTimeMillis() - start);
        pw.println(data4[0]);
        System.gc(); //GC BEFORE NEXT RUN
        //Using Array Streams
        start = System.currentTimeMillis();
        data5 = Arrays.stream(br.readLine().split(" ")).mapToInt(Integer::parseInt).toArray();
        System.out.println(System.currentTimeMillis() - start);
        pw.println(data5[0]);
...
//        }
    ...
    private static class InputReader4 {
         ...
         */
        public InputReader4(int bufferSize) {
