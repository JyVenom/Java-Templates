...
public class TarjanSCCBetter {
    ...
    public TarjanSCCBetter(List<List<Integer>> graph) {
    ...
    public static void main(String[] arg) {
        ...
        TarjanSCCBetter solver = new TarjanSCCBetter(graph);
    ...
    private void dfs(int at) {
      ...
      /*
       TODO(william): investigate whether the proper way to update the low links
