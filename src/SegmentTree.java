...
public class SegmentTree {
    ...
    private final SegmentCombinationFn segmentCombinationFn;
    ...
    public SegmentTree(
        ...
        BinaryOperator<Long> sumFn = Long::sum;
    ...
    private static void rangeSumQueryExample() {
        ...
        long[] values = {1, 2, 3, 2};
        SegmentTree st =
                new SegmentTree(values, SegmentCombinationFn.SUM);
    ...
    private static void rangeMinQueryExample() {
        ...
        long[] values = {1, 2, 3, 2};
        SegmentTree st =
                new SegmentTree(values, SegmentCombinationFn.MIN);
    ...
    private static void rangeMaxQueryExample() {
        ...
        long[] values = {1, 2, 3, 2};
        SegmentTree st =
                new SegmentTree(values, SegmentCombinationFn.MAX);
